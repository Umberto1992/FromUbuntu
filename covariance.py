        ...
        for iii in range(columns):
            ...
            for j in range (3):
                ...
                for jjj in range (3):
                    ...
                    covmat[1,0,1,i,iii] += (a1*b2 - a2*b1)/l_pixels
                    covmat[1,1,0,i,iii] += (a2**2 + b2**2)/l_pixels
                    covmat[1,1,1,i,iii] += 0
                    covmat[1,2,0,i,iii] += (a2*a3 + b2*b3)/l_pixels
                    covmat[1,2,1,i,iii] += (a3*b1 - a1*b3)/l_pixels
                    covmat[2,0,0,i,iii] += (a1*a2 + b1*b3)/l_pixels
                    covmat[2,0,1,i,iii] += (a1*b3 - a3*b1)/l_pixels
                    covmat[2,1,0,i,iii] += (a2*a3 + b2*b3)/l_pixels
                    covmat[2,1,1,i,iii] += (a2*b3 - a3*b2)/l_pixels
                    covmat[2,2,0,i,iii] += (a3**2 + b3**2)/l_pixels
